...
enum {
	...
	POWER_SUPPLY_CHARGE_TYPE_STANDARD,	/* normal speed (5.10) */
	POWER_SUPPLY_CHARGE_TYPE_ADAPTIVE,	/* dynamically adjusted (5.10) */
	POWER_SUPPLY_CHARGE_TYPE_CUSTOM,	/* use CHARGE_CONTROL_* (5.10) */
	POWER_SUPPLY_CHARGE_TYPE_LONGLIFE,	/* slow, longer life (5.10) */
	POWER_SUPPLY_CHARGE_TYPE_FAST,
...
enum {
	...
	POWER_SUPPLY_HEALTH_CALIBRATION_REQUIRED,	/* 5.10 */
