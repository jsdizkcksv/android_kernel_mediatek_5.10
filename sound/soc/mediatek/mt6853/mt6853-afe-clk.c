...
/*
 *  mt6853-afe-clk.c  --  Mediatek 6853 afe clock ctrl
 *
...
int mt6853_afe_enable_clock(struct mtk_base_afe *afe)
{
	...
	ret = mt6853_set_audio_int_bus_parent(afe,
					      CLK_CLK26M);
...
{
	return (apll == MT6853_APLL1) ? 180633600 : 196608000;
}

int mt6853_get_apll_by_rate(struct mtk_base_afe *afe, int rate)
{
	return ((rate % 8000) == 0) ? MT6853_APLL2 : MT6853_APLL1;
}
...
static const struct mt6853_mck_div mck_div[MT6853_MCK_NUM] = {
	[MT6853_I2S0_MCK] = {
...
{
	struct mt6853_afe_private *afe_priv = afe->platform_priv;
	int apll = mt6853_get_apll_by_rate(afe, rate);
	int apll_clk_id = apll == MT6853_APLL1 ?
