...
#include "agateov16a1qmipiraw_Sensor.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = AGATEOV16A1Q_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
{
	kal_uint32 real_dig_gain = 1;//MIN Dgain
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(agateov16a1q_init_setting,
			sizeof(agateov16a1q_init_setting) / sizeof(kal_uint16));
}	/*	sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(agateov16a1q_preview_setting,
		sizeof(agateov16a1q_preview_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(agateov16a1q_capture_setting,
		sizeof(agateov16a1q_capture_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(agateov16a1q_hs_video_setting,
		sizeof(agateov16a1q_hs_video_setting) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	...
	table_write_cmos_sensor(agateov16a1q_custom1_setting,
		sizeof(agateov16a1q_custom1_setting) / sizeof(kal_uint16));
}
...
static void custom2_setting(void)
{
    ...
    preview_setting();
    //table_write_cmos_sensor(agateov16a1q_custom2_setting,
    //sizeof(agateov16a1q_custom2_setting) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	LOG_INF("AGATEOV16A1Q get_imgsensor_id in\n");
...
UINT32 AGATEOV16A1Q_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("AGATEOV16A1Q_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	AGATEOV16A1Q_MIPI_RAW_SensorInit	*/
