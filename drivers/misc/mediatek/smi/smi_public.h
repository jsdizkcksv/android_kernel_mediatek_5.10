 ...
 *
 * AGATE 5.10 port: legacy SMI helper API used by the ported MediaTek
 * drivers.  The IOMMU/larb entry points live in <soc/mediatek/smi.h>,
...
/* 5.10: provided by <soc/mediatek/smi.h> : s32 smi_sysram_enable(const u32 master_id, const bool enable, const char *user); */
#else
...
/* 5.10: provided by <soc/mediatek/smi.h> : #define smi_sysram_enable(master_id, enable, user) ((void)0) */
#endif
