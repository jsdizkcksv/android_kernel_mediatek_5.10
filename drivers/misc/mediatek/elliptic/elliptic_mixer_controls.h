...
#define ELLIPTIC_OBJ_ID_ENGINE_DATA 8
...
#define ELLIPTIC_TAG_INFO_MAX_SIZE             128
...
/** custom settings */
#define ELLIPTIC_SYSCONF_CUSTOM_SETTING_COUNT 16
#define ELLIPTIC_SYSCONF_CUSTOM_SETTING_MAX_VALUE 0x7FFFFFFF
...
#define ELLIPTIC_SYSTEM_CONFIGURATION_LIB_ID 33
...
struct elliptic_system_configuration_parameters_cache {
	...
	int32_t log_level;
	int32_t custom_settings[ELLIPTIC_SYSCONF_CUSTOM_SETTING_COUNT];
