...
#define HVDCP3_CLASS_B_BUS_CURRENT_MA			2600
#define HVDCP3_CLASS_A_BAT_CURRENT_MA			3400
#define HVDCP3_CLASS_A_BUS_CURRENT_MA			1500
...
struct flash2_policy {
	...
	/* qc30 tune threshold */
	uint16_t bus_curr_gap;
	uint16_t bat_curr_gap;
	uint16_t fcc_gap;
};
