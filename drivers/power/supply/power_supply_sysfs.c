...
static struct power_supply_attr power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(CHARGE_FULL_ESTIMATE),
	POWER_SUPPLY_ATTR(RESISTANCE_AVG),
	POWER_SUPPLY_ATTR(RES_FILTER_COUNT),
	...
	POWER_SUPPLY_ATTR(MOISTURE_DETECTION_ENABLE),
...
static const char * const power_supply_usbc_text[] = {
	"Nothing attached", "SDP", "CDP", "DCP", "ACA", "reserved",
