...
#define USBIN_PDC_SETUP_VOTER		"USBIN_PDC_SETUP_VOTER"
#define USBIN_PDC_SETCURRENT_VOTER	"USBIN_PDC_SETCURRENT_VOTER"
#define FV_PDC_SET_CV_VOTER		"FV_PDC_SET_CV_VOTER"
#define FCCMAIN_PDC_SETCURRENT_VOTER	"FCCMAIN_PDC_SETCURRENT_VOTER"
...
struct pdc {
	...
	int pdc_input_current_limit_setting_collapse;
};
...
extern void disable_pdc_voter(void);
