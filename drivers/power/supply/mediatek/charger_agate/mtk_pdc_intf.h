...
#define USBIN_PDC_INTF_AICR_VOTER		"USBIN_PDC_INTF_AICR_VOTER"
#define USBIN_PDC_INTF_SETUP_VOTER		"USBIN_PDC_INTF_SETUP_VOTER"
#define FCCMAIN_PDC_INTF_AICR_VOTER		"FCCMAIN_PDC_INTF_AICR_VOTER"
