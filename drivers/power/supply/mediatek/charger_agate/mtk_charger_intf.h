...
#define USBIN_CHG_PLUG_INOUT_VOTER		"USBIN_CHG_PLUG_INOUT_VOTER"
#define USBIN_THERMAL_INPUT_CURRENT_VOTER	"USBIN_THERMAL_INPUT_CURRENT_VOTER"
#define FV_CHG_FASTCHARGER_MODE_VOTER		"FV_CHG_FASTCHARGER_MODE_VOTER"
#define FCCMAIN_DET_SET_COOL_MODE_VOTER		"FCCMAIN_DET_SET_COOL_MODE_VOTER"
#define FCCMAIN_CHG_PLUG_INOUT_VOTER		"FCCMAIN_CHG_PLUG_INOUT_VOTER"
#define FCCMAIN_CHG_JEITA_VOTER			"FCCMAIN_CHG_JEITA_VOTER"
#define FCCMAIN_CHG_THERMAL_VOTER		"FCCMAIN_CHG_THERMAL_VOTER"
#define FCC_CHG_STEPCHG_VOTER		"FCC_CHG_STEPCHG_VOTER"
#define FCC_CHG_JEITA_VOTER		"FCC_CHG_JEITA_VOTER"
#define FCC_CHG_THERMAL_VOTER		"FCC_CHG_THERMAL_VOTER"
#define FCC_CHG_COOL_MODE_VOTER		"FCC_CHG_COOL_MODE_VOTER"

#define CHG_INPUT_SUSPEND_VOTER		"CHG_INPUT_SUSPEND_VOTER"
#define CHG_USER_VOTER			"CHG_USER_VOTER"
...
struct charger_custom_data {
	...
	int jeita_temp_tn1_to_t0_cv_a;
	int jeita_temp_tn1_to_t0_cv_b;
	...
	int temp_tn1_to_t0_fcc_a;
	int temp_tn1_to_t0_fcc_b;
...
struct charger_manager {
	...
	struct charger_device *chg3_dev;
	struct charger_device *chg4_dev;

	struct charger_device *chg5_dev;
	struct notifier_block chg5_nb;
	struct charger_data chg5_data;

	struct adapter_device *pd_adapter;
#ifdef CONFIG_XMUSB350_DET_CHG
	enum xmusb350_chg_type xmusb_chr_type;
	int xmusb_vid;
#endif
...
struct mt_charger {
	...
	bool vbus_disable;
	bool cool_mode;
	bool battery_67w; /*use to distinguish 67w and 120w*/
