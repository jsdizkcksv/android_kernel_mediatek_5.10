...
/*
 * AGATE 5.10 port: this helper is already provided by mtk_drm_drv.c in the
 * 5.10 tree; keeping a second definition here breaks the mediatek-drm link
 * with a duplicate symbol.  The declaration lives in mtk_drm_fbdev.h.
 */
